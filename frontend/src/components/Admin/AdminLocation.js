...
const AdminLocation = () => {
  ...
  useEffect(() => {
    axios
      .get("https://alliedpublications-11.onrender.com/api/home/locations")
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://alliedpublications-11.onrender.com/api/home/admin/locations", { name: location });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://alliedpublications-11.onrender.com/api/home/admin/locations/${id}`);
