...
const AdminConference = () => {
  ...
  const fetchConferenceData = async () => {
    try {
      const res = await axios.get("https://alliedpublications-11.onrender.com/api/home/conference");
  ...
  const handleUpdate = async () => {
    try {
      await axios.put("https://alliedpublications-11.onrender.com/api/home/admin/conference", conferenceData);
