...
//     try {
//       const response = await axios.get("https://alliedpublications-11.onrender.com/api/cart", {
...
//     try {
//       await axios.delete(`https://alliedpublications-11.onrender.com/api/cart/${itemId}`, {
//         headers: { Authorization: token },
//       });
...
//     try {
//       await axios.put(
//         `https://alliedpublications-11.onrender.com/api/cart/${itemId}`,
